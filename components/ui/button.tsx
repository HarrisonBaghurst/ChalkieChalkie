...
/*  Restyled to the app's palette and type scale. Two rules for anyone editing
    this file:
      - `dark:` modifiers are dead here. Nothing sets `.dark` on <html>; the
        app is permanently dark via `:root`, so a dark: branch never fires.
      - No `text-*` size utility in the base. Sizing comes from the text-body /
        text-caption component classes, and a utility-layer `text-sm` would
        outrank them and silently win. */
