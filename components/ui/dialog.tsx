...
/*  Below lg a centred panel leaves a phone's dialog cramped between the
    viewport edges and fighting the on-screen keyboard, so the multi-step
    dialogs fill the screen instead and restore the centred panel at lg.
...
const MOBILE_FULL_SCREEN =
  "inset-0 h-full w-full max-w-none translate-x-0 translate-y-0 rounded-none p-6 sm:max-w-none lg:inset-auto lg:top-1/2 lg:left-1/2 lg:h-auto lg:w-full lg:max-w-150 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:rounded-xl lg:p-8"
